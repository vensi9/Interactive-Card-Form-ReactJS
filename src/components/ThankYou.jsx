                ...
                {cardDetails && (
                    <>
                                    ...
                                    <Flex justifyContent='space-evenly' flexDirection={'column'} gap={{ base: '9vw', sm: '5vw', lg: '3.5vw' }}>
                                        ...
                                        <Flex justifyContent="space-between" flexDir={'column'} gap={'1vw'}>
                                            ...
                                            <Flex justifyContent="space-between">
                                                <Text fontSize={{ base: 9, sm: 11, lg: 12 }} letterSpacing={1}> {cardDetails.cardName}</Text>
                                                <Flex>
                                                    <Text fontSize={{ base: 9, sm: 11, lg: 12 }} letterSpacing={1}>{cardDetails.expiryMonth}/</Text>
                                                    <Text fontSize={{ base: 9, sm: 11, lg: 12 }} letterSpacing={1}>{cardDetails.expiryYear}</Text>
                                                </Flex>
                                            </Flex>
                                        </Flex>
                                    </Flex>
                        ...
                        <Flex w={{ base: 290, sm: 350, md: 300, lg: 350 }} fontFamily={'Space Grotesk'} flexDir={'column'} textAlign={'center'} justifyContent={'center'} alignItems={'center'} position={'relative'} bottom={5}>
                            ...
                            <Button color={'hsl(270, 3%, 87%)'} py={{ md: 5, lg: 6 }} fontSize={{ md: 14, lg: 16 }} w={'-webkit-fill-available'} mt={{ base: 7, lg: 10 }} type="submit"  _hover={{ bg: '#350a4f', transition: '0.3s' }} bg={'hsl(278, 68%, 11%)'} fontWeight={500}>
                                Continue
                            </Button>
                        </Flex>
                    </>
